...
export default function DashboardDeltaPerkasa() {
  ...
  const operatorDatabase = ['ACO', 'AGUNG OPT SEREP', 'AGUS SALIM', 'AKBAR BARRU', 'ALIF SUGALI R', 'AMRAN',
    'NAPRIL', 'APUNG', 'ARIF', 'ARIFIN', 'ARMAN', 'BAIR',
    'AIDIL NOOR RANDANAN', 'DEDI MANDIODO', 'DUDI', 'EDI EXC03', 'EDO', 'FILHAM',
    'HANAFI', 'HERI', 'IDRIS', 'IDUL', 'IKBAL', 'ILHAM',
    'ILHAM SIKKI', 'IRSAL', 'JABIR', 'JUNI', 'MUSTARI', 'NARDI',
    'PONG WILDA', 'PUDDING', 'RESKI', 'REZA', 'RICHARD', 'RIO',
    'RIZA SAID ICA', 'SAMSUL SINJAI', 'SUMITRO', 'SURAHMAN', 'SUWARDI CUA', 'TINO E.09',
    'ZAKIR', 'ZEMPO', 'SAPRIADI MAROS', 'SYAMSUDDIN.S UDING', '-', 'RIZAL SEREP AWING',
    'RAMADHAN', 'HENDRA MARSUKI', 'WAHYU', 'UMAR', 'RIAN IRAWAN', 'SUPANDA',
    'MUHLIS', 'OPERATOR PENYEWA', 'SYAHFRUL', 'MUHKLIZIN', 'IRSAN', 'SUDIRMAN',
    'MADIL', 'IRWAN', 'NASRULLA BANNERINGGI', 'JUMARDANI', 'MUHAMMAD YUSUF', 'IWAN',
    'RAHMAN ARHAM', 'AWAL SEPTIAN', 'SURYADI', 'TRI SYAWAL', 'ANCU', 'MUHAMMAD RIADI SAPUTRA',
    'DEDI SAMSIR', 'HARIANTO BARRU', 'RENALDI', 'ISON', 'DONI', 'ADIN GORONTALO',
    'WANDI - IRPAN', 'ALI', 'RANDI K', 'ANHAR MOROMBO', 'REINALDI MOROMBO', 'ADHY',
    'ASKAR', 'MUH ISLAM', 'RANDI 02', 'ASPAR', 'ASRI', 'HASANUDDIN',
    'USMAN', 'HASBI', 'JAYADI', 'HARIANTO MALINO', 'SALMAN OGE', 'SYUKUR',
    'MADAN', 'SABIR', 'SULHAJI PINRANG', 'ANGGA MAKASSAR', 'MUHAMMAD ARIF GUNAWAN', 'WAWAN GUNAWAN',
    'ADHI VIBRO', 'NAHIR', 'RAMLI', 'JAMALUDDIN', 'SUKARDI MAROS', 'SAIMA PP',
    'AGUSTIMUS TANGGO PP', 'YAN MINGGU PP', 'SAFRI MARAJA', 'BASIR SIKKI', 'JUNALDI PP', 'AMOS PALALLO PP',
    'MUNAWIR CACO', 'ANAS', 'MARWIN PP', 'RAHIM', 'MAIL', 'YEREMIA PP',
    'ALFIAN', 'NASRUL DG.SITUJU', 'RAHMAT KARMINTO', 'MUH.NASRUL', 'NOPRI SAHJAN', 'MUH NUR IKHSAN',
    'MUH YUSUF PP', 'ELDIM PP', 'AGUS LIBADI', 'MUH. RIZAL', 'ADIPRANOTO', 'MUHAMMAD AZIS',
    'RUDI HARYONO PP', 'SALMAN AL FARITZY', 'ABD AZIS MAJID', 'ZAKIR MOROWALI', 'MUH. IKBAL', 'JUNA',
    'IDRIS WAJO', 'KADRI PP', 'FADEL', 'MUHAMMAD BASIR', 'APRIANSA', 'JUMASRI BAKRI',
    'ARMANSYAH', 'YONATAN - KODAL', 'WAHYUDI MAROS', 'RIDWAN PASOLORAN', 'FIRMAN', 'HERMAN MANDE',
    'SUPRIADI', 'MUH. YUNUS', 'ARJUN', 'YULLI PP', 'RISWAN MAROS', 'COLEK - MORAMO',
    'SUATRI', 'MUH. TAHIR', 'DIRHAM', 'ARMAN P', 'RIDWAN KODAL', 'PARDI',
    'ROLLYANTO', 'JAMALUDDIN ABI', 'ARAFAH RAMADHAN', 'BAHAR ASNAWI', 'BASUNI', 'ANDY KODAL',
    'JUMARDI', 'RIFALDO', 'RUSDIN', 'EFANDY HARRYAWAN AKBARI', 'RIDWAN', 'RUSDI NOJENG',
    'FAHRI M. LEMPALAI', 'SAMILA', 'KASMIR', 'NASIR', 'ABD. HAFID', 'OPERATOR TOTALLANG',
    'SYAMSU ALAM TOTALLANG', 'MUH. YUNUS TOTALLANG', 'SUPRIADI TOTALLANG', 'IRWAN SIKKI', 'ADAM KODAL', 'SALIM KODAL',
    'ARIFUDDIN LAROENAI', 'SEPTIAN', 'ANSAR', 'AWAL MUH. WALDIANSYAH', 'MUH. AGUSTUS', 'DIKI KODAL',
    'AIDIL', 'MUH. ALIF IMPUNG', 'ARYA', 'DANDI', 'SIDIK SUNARDI', 'RESKY TOHA LANAS MALIPUNGI',
    'HARDI HERIYANTO', 'ISMAIL OP PENYEWA', 'HAMKA', 'ABD. WAHID PP', 'HENDRO', 'HERMAN KODAL',
    'LA ODE SURATMAN JAYA', 'MUH. TAUFIK - TANGOFA E.89', 'BAHAR DG. TIKA', 'WAHYU ARFAN', 'DG. SAING', 'FIKRAN MOROWALI',
    'IRWAN KOLAKA', 'SATRIA', 'ALAM', 'DANI KODAL', 'NASIR PANGKEP', 'SURIYANTO',
    'DAVID. M', 'SUTOYO', 'TRISNO', 'YUSUF TANDIAJA', 'JUMARDI MAMUJU', 'STEFEN - MORAMO',
    'FADLI KODAL', 'SILVERTES RAI FEBRIANTO', 'EDWIN KODAL', 'BAHAR', 'WAHYU WIRANDA', 'RIOS',
    'AGUS MAROS', 'SUTARNO', 'FIKRAM RAHARDI', 'MUCHTAR', 'TAUFIK KODAL', 'WAWAN PARIGI',
    'SENTUS KONAWE', 'MOH ARABIL AZIM', 'RAHMAT', 'SAMUEL RIVO TA\'ANGGA', 'ULLAH HASRULLAH', 'SEPRIANTO RO\'SON',
    'ARDIN MOROWALI', 'HERI MOROWALI', 'SUARDI CPM', 'MUH. ALFIAN', 'PANTRI', 'RUSTAM GOWA',
    'LOLO', 'JABBAR', 'ABD. RAHIM', 'ABDUL KODAL', 'ILHAM E68', 'HAERUDDIN E68',
    'MUH. MEDY.S WELLO', 'DWI SULTAN WAHYUDI', 'FIRMANSYAH', 'ADRIANO KESO', 'RENDY KURNIAWAN PANGINDA', 'AGUSTINUS DAMIANTO MEGAWONA',
    'SUDIRMAN BULUKUMBA', 'HAMZA', 'HAMSU', 'MOH FADEL I NANGA', 'RISWAN GOWA', 'ABD MUIS',
    'NANDA KRISTIAN PUTRA', 'MUH. AZ-ZHIDIQ', 'HABIBI AT', 'DARWAN', 'SETRA FEBRIAN MAULANA', 'RAHMAN',
    'HASIS', 'M ROHID', 'DAVID BARAKKA KABANGA', 'ASRI SAPUTRA', 'RATNO SETIAWAN', 'FATU RAHMAN KAU',
    'RUSDI HASAN E68', 'MUH AKBAR', 'INDRAWAN SAPUTRA DAUD L E68', 'YUSTIANTO LEMANGGA E36', 'MUSLIMIN', 'SUDIRMAN GOWA E21',
    'RISWAN USMAN E204', 'HERMANSYAH E54', 'OSIANUS JAWA MG04', 'IDUL E46', 'NAJIB', 'MUH AKBAR M',
    'M. IKRAM', 'FERI. P', 'SAHIR EFENDI', 'PUTRA E36', 'AGUS SALIM MKS', 'LUKAS E68',
    'INDRA OP SUMITRO', 'RIDHO ALFANDI', 'FAUZA ANGGARA', 'SAFARUDDIN', 'MELDIARTHO ALVIS HUMA', 'IKHLAS',
    'ALPIAN KANARASI', 'HAIRUL ILHAM', 'INDRA ANUGRAH', 'ABD MALIK', 'NAWAR', 'RIFAN SAPUTRA',
    'SUDARMAN', 'HENDRIK PINRANG', 'HAMDAN', 'SUANTO', 'AL MUNAWAR', 'MUH HARI DARMAWAN',
    'ABDAN', 'FIRMAN BULUKUMBA', 'HENDRIKUS TAA ELA (BARLIS)', 'WIRDAN WIRA PUTRA. S', 'RESKI TAKALAR', 'ARLAM',
    'ILHAM E83', 'DAYAT', 'LUKMAN WAHAB', 'AKRAM DAUD', 'MUH IKHSAN LEBU', 'JUNUSI',
    'ASBAR DJAFAR', 'GHADAVID', 'A. AKBAR PUTRA HANDIKA', 'SARIFUDIN', 'WAHYUDI MKS', 'ANSAR BULUKUMBA',
    'SYAMSUL ALAM SAID', 'ZULKIFLI MKS', 'A. NOLDI', 'ANSAR POLMAN', 'TREIN HARD', 'SAHARUDDIN',
    'KAREL LORENZO SULI', 'OSEN', 'ICHAL BARRU', 'SAWAL', 'MUH RUSLI', 'SIGIT',
    'ANIL', 'WIDI IRAWAN', 'HAMZAH ACHMAD E68', 'YASETH', 'KASWEDI', 'WELFIANSYAH GOGAN',
    'SAHRUL GUNAWAN', 'SYAMSUDDIN', 'OPERATOR PAK UCI', 'WAHYU E68', 'FIRDAUS MAROS', 'ANDI ICHSAN NUR',
    'DAHLAN', 'ANDRIANUS GOA', 'EUFRONIUS STEFANUS TODA', 'MOH. ALWI HASAN', 'SUKRI', 'VINDDIANA LIWAN',
    'REZA PERMADY', 'SYARIFUDDIN', 'AHDE JAYA J', 'KASMAN', 'ARIL', 'CHAIDIR AKSAN (Penyewa)',
    'HENDRIK MEIFANI', 'RIFALDI. M', 'SUHARDI', 'MUH. HILAL MASIR', 'ERSAL EFENDY', 'NOVAL TAGORUMBU',
    'ADI SANTOSO', 'MUH. HASMAN HASTO', 'SYAHRULLAH', 'JUHARDIN BAEN', 'BUSTAM', 'SAIFUDDIN ZUHRI',
    'FEBRI SETIAWAN', 'HERIYANTO', 'AGRIPA AMBALINGGI', 'MAHRUS FADLI', 'RESA RISWANTO', 'SAPRI. S',
    'ROYVEN HARIADI', 'ILYAS SAPPE', 'ABDUL RAHIM SAPUTRA', 'SHARUL', 'ALDI SEBASTIAN', 'HARDIN',
    'DADANG BAYU PONCO SAPUTRO', 'ICHAL', 'YABI', 'SOPYANGGA', 'ABDUL WAZIL E68', 'THEODORUS',
    'HERISON', 'SYAN DEWA', 'RASDIN', 'SURAHMAN AMANG (PENGAWAS PAK UCI)', 'HERMANSYAH SYAMSIR', 'JUDIN (FERDY)',
    'JOHAN (FERDY)', 'FIRMAN (FERDY)', 'IRWAN (FERDY)', 'RASMA (FREDY)', 'MUH RUSLI MAROS', 'SUYANTO',
    'UMAR MAROS', 'INO', 'ABDUL WAHID', 'ABIDIN', 'STANISLAUS BHUKU', 'HERWANDI',
    'NIKO', 'RISMAN', 'YOTAM PETRUS MAATA', 'SUMMANG', 'SIRAJUDDIN', 'FAJRIN PAHRIAWAN',
    'MUHAMMAD YUSUF SAMARINDA', 'MUH. ALFIAN SADDANG', 'GIDION SATTU (FERDY)', 'BRILIAM KATU (FERDY)', 'MUSLIYADI', 'MUH. ADRYANK (FERDY)',
    'NASIR WIJAYA (FERDY)', 'IAN (FERDY)', 'MUH. HASLAN HAMSA', 'MUH ISRA SAMSUDDIN', 'JUMARDIN', 'PAHMI',
    'SUARDI MAROS', 'TAJUDDIN SIJAYA', 'MUALDI', 'AHMAD ALDI', 'RAMLI UNGKAYA', 'JEANS SAPUTRA (FERDY)',
    'REINOL PONDA (FERDY)', 'JULIUS TANDI ARA\' (FERDY)', 'SAMUEL TO\' PAA (fFERDY)', 'ILMAN HIDAYAT (OP Penyewa)'];
